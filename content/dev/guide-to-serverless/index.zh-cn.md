...
date: 2020-08-30
draft: false
tags: ["AWS", "Lambda", "Serverless", "Terraform", "Infrastructure as code", "无服务架构", "Docker", "AWS ECS", "DevOps"]
keywords: ""
...
![](https://img.bmpi.dev/fdb100f8-4391-f0a5-47bf-7bd103b66c41.png)

- 单体应用(Monolithic)：适合创业公司的小型应用；性能好。
- 面向服务(SOA)：适合复杂企业业务的大型应用。
- 微服务(Microservices)：复杂弹性可伸缩应用，适合有经验的团队。
- 无服务(Serverless)：成本低，适合后台任务；也适用于客户量大的应用程序和快速增长并需要无限扩展的应用程序。
